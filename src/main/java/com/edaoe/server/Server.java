...
/**
 * @author Catch
 * @date 2018-09-12 上午10:50
 * @description IDEA 专用于在 IDEA 之下用 main 方法启动，原启动方式在 IDEA 下会报异常
...
public class Server implements IServer {
	...
	public Server(String webAppDir, int port, String context) {
		if (webAppDir == null) {
